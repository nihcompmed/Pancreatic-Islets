...
for fprefix in islets:
    ...
    for pert in range(n_pert):
        ...
        v_file = this_pert_dirr + '/vertices.csv'
        e_file = this_pert_dirr + '/edges.csv'
        ...
        ad_vert_geom_to_PH_file = this_pert_dirr + '/advertices_geom_to_PH.p'
        pickle.dump( ad_cells_info, open( ad_vert_geom_to_PH_file, "wb" ) )

        b_vert_geom_to_PH_file = this_pert_dirr + '/bvertices_geom_to_PH.p'

...
def ks2d2s(x1, y1, x2, y2, nboot=None, extra=False):
    ...
    if nboot is None:
        ...
        result = Parallel(n_jobs=6, verbose=4)(delayed(single_boot)\
                                    (i, n, x, y, n1, n2) for i in range(nboot))
...
def single_boot(i, n, x, y, n1, n2):
    idx = random.choice(n, n, replace=True)
    ix1, ix2 = idx[:n1], idx[n1:]

    return avgmaxdist(x[ix1], y[ix1], x[ix2], y[ix2])
